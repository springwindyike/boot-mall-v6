...
public class ProductCategoryParentListDirective extends BaseDirective {
	...
	public static ProductCategoryParentListDirective productCategoryParentListDirective;

	@PostConstruct
	public void init() {
		productCategoryParentListDirective = this;
		productCategoryParentListDirective.productCategoryService = this.productCategoryService;
	}
